...
if __name__ == "__main__":
    ...
    p0 = 0.05  # Initial infection probability
    p1 = 0.02  # Probability of infection spread to neighbors
    time_steps = 100  # Number of days to simulate the infection spread
    
    infection_progression = infect(adj_matrix, p0, p1, time_steps)
